    ...
    <div class="container">
        <section class="section">
            <div class="buttons">
                ...
                <button class="button is-danger is-rounded" @click="modalActive3 = true"> Modal Active3</button>
            </div>
        </section>
    </div>

    <ImgModal :active="modalActive" @close="modalActive = false" url="https://picsum.photos/200/300?random=1">
    </ImgModal>
    <ImgModal :active="modalActive2" @close="modalActive2 = false" url="https://picsum.photos/200/300?random=2">
    </ImgModal>
